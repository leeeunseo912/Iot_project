...
### Description<br>
* 이 프로젝트는 코로나 기간동안 집에 머무는 시간이 증가하면서 스마트폰으로 내 방을 조금 더 효율성있게 만들어보자! 라는 아이디어로 시작했습니다.<br>
* 라즈베리파이와 아두이노, 안드로이드 앱 간에 mqtt통신 방식으로 값을 주고 받습니다.<br>
...
3. 스마트 블라인드, 반려동물 사료주기, 택배도착 알림 서비스 화면<br>
